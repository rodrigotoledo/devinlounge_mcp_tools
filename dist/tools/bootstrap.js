function railsBootstrap(args) {
    ...
    const stylingStep = styling === 'tailwindcss-rails'
    ...
    const paginationStep = pagination === 'pagy'
    ...
    const searchStep = search === 'ransack'
    ...
    const uploadsStep = uploads === 'active-storage-image-processing'
    ...
    const adminStep = admin === 'activeadmin'
    ...
    const auditingStep = auditing === 'paper_trail'
    ...
    const multiTenancyStep = multiTenancy === 'acts_as_tenant'
...
function fastapiBootstrap(args) {
...
function phoenixBootstrap(args) {
...
export async function getProjectBootstrap(args) {
